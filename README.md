...
This project analyzes how market sentiment (Fear/Greed) relates to trader behavior and performance using Hyperliquid trading data.
...
(Note: The datasets used are provided as part of the assignment and are referenced via external links.)
